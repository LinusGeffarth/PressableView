...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of PressableView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Linus Geffarth/PressableView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Linus Geffarth' => 'linus@geffarth.de' }
  s.source           = { :git => 'https://github.com/Linus Geffarth/PressableView.git', :tag => s.version.to_s }
